/**
 * Lesson context — equations, rules, standards, skills, misconceptions, and narratives
 * used to ground generated content (guides, problems) in pedagogy and curriculum.
 */
...
// ──────────────────────────────────────────────
// Few-shot example problems (for grounding)
// ──────────────────────────────────────────────
export interface FewShotExample {
  ...
  problem: {
    title: string;
    description: string;
    steps: { step_number: number; label: string; instruction: string; content?: string; correct_answer?: string; hint?: string }[];
  };
}
...
export const FEW_SHOT_EXAMPLES: FewShotExample[] = [
  {
    ...
    problem: {
      ...
      steps: [
        { step_number: 1, label: "Equation", instruction: "Select the correct rate law:", content: "[A]ₜ = [A]₀ − k·t" },
        { step_number: 2, label: "Knowns", instruction: "Identify known variables:", content: "[A]₀ = 0.80 M\nk = 0.020 M/s\nt = 20 s" },
        { step_number: 3, label: "Substitute", instruction: "Plug values into the equation:", content: "[A]ₜ = 0.80 − (0.020)(20)" },
        { step_number: 4, label: "Calculate", instruction: "Compute the product:", content: "(0.020)(20) = 0.40" },
        { step_number: 5, label: "Answer", instruction: "Final answer with units:", content: "[A]ₜ = 0.80 − 0.40 = 0.40 M" },
      ],
    },
  },
  {
    ...
    problem: {
      ...
      steps: [
        { step_number: 1, label: "Equation", instruction: "Select the correct rate law:", content: "[A]ₜ = [A]₀ − k·t" },
        { step_number: 2, label: "Knowns", instruction: "Identify known variables:", content: "[A]₀ = 0.60 M\nk = 0.015 M/s\nt = 10 s" },
        { step_number: 3, label: "Substitute", instruction: "Multiply k × t:", correct_answer: "0.15", hint: "Multiply 0.015 × 10." },
        { step_number: 4, label: "Calculate", instruction: "Subtract from [A]₀:", correct_answer: "0.45", hint: "What's 0.60 − 0.15?" },
        { step_number: 5, label: "Answer", instruction: "Final concentration with units:", correct_answer: "0.45 M", hint: "Include the molarity unit." },
      ],
    },
  },
];
...
// ──────────────────────────────────────────────
// Build lesson context for API requests (sent as rag_context to backend)
// ──────────────────────────────────────────────
export function buildLessonContext(unitId: string, lessonName?: string) {
