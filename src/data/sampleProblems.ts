import { Problem, ReferenceStep } from "@/types/chemistry";
...
export const referenceSteps: ReferenceStep[] = [
  { stepNumber: 1, title: "Equation:", content: "[A]ₜ = [A]₀ − k·t" },
  { stepNumber: 2, title: "Knowns:", content: "Identify values:\n[A]₀, k, t" },
  { stepNumber: 3, title: "Substitute:", content: "Plug values into equation" },
  { stepNumber: 4, title: "Calculate:", content: "Compute k × t, then subtract" },
  { stepNumber: 5, title: "Answer:", content: "Express with correct units (M)" },
];

export const fullyWorkedExample: Problem = {
  id: "zero-order-worked",
  title: "Zero-Order Reaction Kinetics",
  ...
  difficulty: "medium",
  steps: [
    { id: "worked-1", stepNumber: 1, type: "given", label: "Equation", instruction: "Select the correct rate law:", content: "[A]ₜ = [A]₀ − k·t" },
    { id: "worked-2", stepNumber: 2, type: "given", label: "Knowns", instruction: "Identify known variables:", content: "[A]₀ = 0.80 M\nk = 0.020 M/s\nt = 20 s" },
    { id: "worked-3", stepNumber: 3, type: "given", label: "Substitute", instruction: "Plug values into the equation:", content: "[A]ₜ = 0.80 − (0.020)(20)" },
    { id: "worked-4", stepNumber: 4, type: "given", label: "Calculate", instruction: "Compute the product:", content: "(0.020)(20) = 0.40" },
    { id: "worked-5", stepNumber: 5, type: "given", label: "Answer", instruction: "Final answer with units:", content: "[A]ₜ = 0.80 − 0.40 = 0.40 M" },
  ],
};

// Additional worked examples for multi-example reference
export const additionalWorkedExamples: Problem[] = [
  {
    id: "zero-order-worked-2",
    title: "Zero-Order Reaction Kinetics",
    description: "The decomposition of compound Q follows zero-order kinetics with k = 0.030 M/s. Initial concentration [A]₀ = 0.90 M. Find [A] after 10 s.",
    topic: "Reaction Kinetics",
    difficulty: "medium",
    steps: [
      { id: "w2-1", stepNumber: 1, type: "given", label: "Equation", instruction: "Select the correct rate law:", content: "[A]ₜ = [A]₀ − k·t" },
      { id: "w2-2", stepNumber: 2, type: "given", label: "Knowns", instruction: "Identify known variables:", content: "[A]₀ = 0.90 M\nk = 0.030 M/s\nt = 10 s" },
      { id: "w2-3", stepNumber: 3, type: "given", label: "Substitute", instruction: "Plug values into the equation:", content: "[A]ₜ = 0.90 − (0.030)(10)" },
      { id: "w2-4", stepNumber: 4, type: "given", label: "Calculate", instruction: "Compute the product:", content: "(0.030)(10) = 0.30" },
      { id: "w2-5", stepNumber: 5, type: "given", label: "Answer", instruction: "Final answer with units:", content: "[A]ₜ = 0.90 − 0.30 = 0.60 M" },
    ],
  },
  {
    id: "zero-order-worked-3",
    title: "Zero-Order Reaction Kinetics",
    description: "The decomposition of compound R follows zero-order kinetics with k = 0.050 M/s. Initial concentration [A]₀ = 1.50 M. Find [A] after 6 s.",
    topic: "Reaction Kinetics",
    difficulty: "medium",
    steps: [
      { id: "w3-1", stepNumber: 1, type: "given", label: "Equation", instruction: "Select the correct rate law:", content: "[A]ₜ = [A]₀ − k·t" },
      { id: "w3-2", stepNumber: 2, type: "given", label: "Knowns", instruction: "Identify known variables:", content: "[A]₀ = 1.50 M\nk = 0.050 M/s\nt = 6 s" },
      { id: "w3-3", stepNumber: 3, type: "given", label: "Substitute", instruction: "Plug values into the equation:", content: "[A]ₜ = 1.50 − (0.050)(6)" },
      { id: "w3-4", stepNumber: 4, type: "given", label: "Calculate", instruction: "Compute the product:", content: "(0.050)(6) = 0.30" },
      { id: "w3-5", stepNumber: 5, type: "given", label: "Answer", instruction: "Final answer with units:", content: "[A]ₜ = 1.50 − 0.30 = 1.20 M" },
    ],
  },
];
