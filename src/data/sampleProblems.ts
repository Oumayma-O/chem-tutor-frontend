  ...
  easy: [
    {
      ...
      steps: [
        { id: "e1-1", step_number: 1, type: "drag_drop" as const, is_given: true, label: "Equation", instruction: "Select the correct rate law:", content: "[A]ₜ = [A]₀ − k·t", equation_parts: ["[A]ₜ", "=", "[A]₀", "−", "k", "·", "t"], correct_equation: "[A]ₜ = [A]₀ − k · t" },
        { id: "e1-2", step_number: 2, type: "multi_input" as const, is_given: true, label: "Knowns", instruction: "Identify known variables:", content: "[A]₀ = 0.50 M\nk = 0.010 M/s\nt = 10 s", input_fields: [{ label: "[A]₀", value: "0.50", unit: "M" }, { label: "k", value: "0.010", unit: "M/s" }, { label: "t", value: "10", unit: "s" }] },
    ...
    },
    {
      ...
      difficulty: "easy" as const,
      steps: [
        { id: "e2-1", step_number: 1, type: "drag_drop" as const, is_given: true, label: "Equation", instruction: "Select the correct rate law:", content: "[A]ₜ = [A]₀ − k·t", equation_parts: ["[A]ₜ", "=", "[A]₀", "−", "k", "·", "t"], correct_equation: "[A]ₜ = [A]₀ − k · t" },
        { id: "e2-2", step_number: 2, type: "multi_input" as const, is_given: true, label: "Knowns", instruction: "Identify known variables:", content: "[A]₀ = 1.00 M\nk = 0.020 M/s\nt = 5 s", input_fields: [{ label: "[A]₀", value: "1.00", unit: "M" }, { label: "k", value: "0.020", unit: "M/s" }, { label: "t", value: "5", unit: "s" }] },
  ...
  medium: [
    {
      ...
      steps: [
        { id: "m1-1", step_number: 1, type: "drag_drop" as const, is_given: true, label: "Equation", instruction: "Select the correct rate law:", content: "[A]ₜ = [A]₀ − k·t", equation_parts: ["[A]ₜ", "=", "[A]₀", "−", "k", "·", "t"], correct_equation: "[A]ₜ = [A]₀ − k · t" },
        { id: "m1-2", step_number: 2, type: "multi_input" as const, is_given: true, label: "Knowns", instruction: "Identify known variables:", content: "[A]₀ = 0.60 M\nk = 0.015 M/s\nt = 10 s", input_fields: [{ label: "[A]₀", value: "0.60", unit: "M" }, { label: "k", value: "0.015", unit: "M/s" }, { label: "t", value: "10", unit: "s" }] },
    ...
    },
    {
      ...
      difficulty: "medium" as const,
      steps: [
        { id: "m2-1", step_number: 1, type: "drag_drop" as const, is_given: true, label: "Equation", instruction: "Select the correct rate law:", content: "[A]ₜ = [A]₀ − k·t", equation_parts: ["[A]ₜ", "=", "[A]₀", "−", "k", "·", "t"], correct_equation: "[A]ₜ = [A]₀ − k · t" },
        { id: "m2-2", step_number: 2, type: "multi_input" as const, is_given: true, label: "Knowns", instruction: "Identify known variables:", content: "[A]₀ = 0.75 M\nk = 0.025 M/s\nt = 8 s", input_fields: [{ label: "[A]₀", value: "0.75", unit: "M" }, { label: "k", value: "0.025", unit: "M/s" }, { label: "t", value: "8", unit: "s" }] },
  ...
  hard: [
    {
      ...
      steps: [
        { id: "h1-1", step_number: 1, type: "drag_drop" as const, is_given: true, label: "Equation", instruction: "Select the correct rate law:", content: "[A]ₜ = [A]₀ − k·t", equation_parts: ["[A]ₜ", "=", "[A]₀", "−", "k", "·", "t"], correct_equation: "[A]ₜ = [A]₀ − k · t" },
        { id: "h1-2", step_number: 2, type: "multi_input" as const, is_given: true, label: "Knowns", instruction: "Identify known variables:", content: "[A]₀ = 0.85 M\nk = 0.0125 M/s\nt = 24 s", input_fields: [{ label: "[A]₀", value: "0.85", unit: "M" }, { label: "k", value: "0.0125", unit: "M/s" }, { label: "t", value: "24", unit: "s" }] },
    ...
    },
    {
      ...
      difficulty: "hard" as const,
      steps: [
        { id: "h2-1", step_number: 1, type: "drag_drop" as const, is_given: true, label: "Equation", instruction: "Select the correct rate law:", content: "[A]ₜ = [A]₀ − k·t", equation_parts: ["[A]ₜ", "=", "[A]₀", "−", "k", "·", "t"], correct_equation: "[A]ₜ = [A]₀ − k · t" },
        { id: "h2-2", step_number: 2, type: "multi_input" as const, is_given: true, label: "Knowns", instruction: "Identify known variables:", content: "[A]₀ = 1.25 M\nk = 0.0175 M/s\nt = 30 s", input_fields: [{ label: "[A]₀", value: "1.25", unit: "M" }, { label: "k", value: "0.0175", unit: "M/s" }, { label: "t", value: "30", unit: "s" }] },
