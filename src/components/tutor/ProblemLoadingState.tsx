...
export function ProblemLoadingState() {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-12">
      {/* Loading container: mascot + orbit only, no card */}
      <div className="relative flex flex-col items-center">
        {/* Orbit: 4 blue dots rotating around center */}
        <div
        ...
        >
            ...
            return (
              <div
                ...
                style={{
                  ...
                  // Combined animation: orbit + pulse (avoids CSS class conflict)
          ...
          {/* Mascot centered inside orbit, smaller, subtle breathing */}
        ...
        {/* Text below with top margin, no overlap */}
